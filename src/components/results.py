...
def render_results(prob: float, pred: int, report_html: str, 
    ...
    Args:
        ...
        threshold: Decision threshold from model (if None, uses default)
    """
    st.markdown('<div class="thin-divider"></div>', unsafe_allow_html=True)
    
    # Determine verdict styling
    thresh = threshold if threshold is not None else RISK_THRESHOLD_DEFAULT
    ...
    # Probability bar
    _render_probability_bar(prob, thresh)
...
def _render_probability_bar(prob: float, thresh: float):
